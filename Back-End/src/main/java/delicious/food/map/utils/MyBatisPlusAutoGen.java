...
public class MyBatisPlusAutoGen {

    public static void main(String[] args) {
        //1、配置数据源
        FastAutoGenerator.create("jdbc:mysql://127.0.0.1:3306/delicious-food-map", "root", "123456")
                //2、全局配置
                ...
                .packageConfig(builder -> {
                    builder.parent("delicious.food.map") // 设置父包名
                            .moduleName("aotuGen")   //设置模块包名
                ...
                .strategyConfig(builder -> {
                    builder.addInclude("sys_user", "poi_data", "category") // 设置需要生成的数据表名
